...
class getSHA(QThread):
    ...
    def checkBranch(self, real_time):
        ...
        remoteSHA = str(subprocess.check_output("git rev-parse EchoHarbor_N38A_Main"))
    ...
    def writeSHA(self, real_time, remoteSHA, localSHA):
        with open("C:/Users/SVD_INTEL_NUC/Desktop/TerryFolder/git_test/SHA_log/"+ real_time +"_SHA._log.log", "w") as file:
    ...
    def showFile(self):
        subprocess.call('dir', shell=True, cwd = 'D:\SourceCode_SM2269') 
